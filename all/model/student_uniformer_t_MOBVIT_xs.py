...
from backbone.mobilevit import MobileViT_S
...
class SRAA(nn.Module):
    ...
    def __init__(self):
        ...
        self.resnet = MobileViT_S()
        self.resnet_depth = MobileViT_S()
        self.raa1 = RRAA(in_channel=64, out_channel=64, h=80, w=80)
        self.raa2 = RRAA(in_channel=96, out_channel=96, h=40, w=40)
        self.raa3 = RRAA(in_channel=128, out_channel=128, h=20, w=20)
        self.raa4 = RRAA(in_channel=640, out_channel=640, h=10, w=10)
        ...
        self.fenliang1 = BasicConv2d(640, 16, 1)
        self.fenliang2 = BasicConv2d(640 + 128, 16, 1)
        self.fenliang3 = BasicConv2d(640 + 128 + 96, 16, 1)
        self.fenliang4 = BasicConv2d(640 + 128 + 96 + 64, 16, 1)
        ...
        self.er1 = nn.Conv2d(64, 64, 1)
        self.er2 = nn.Conv2d(96, 128, 1)
        self.er3 = nn.Conv2d(128, 256, 1)
        self.er4 = nn.Conv2d(640, 512, 1)

        self.ed1 = nn.Conv2d(64, 64, 1)
        self.ed2 = nn.Conv2d(96, 128, 1)
        self.ed3 = nn.Conv2d(128, 256, 1)
        self.ed4 = nn.Conv2d(640, 512, 1)
