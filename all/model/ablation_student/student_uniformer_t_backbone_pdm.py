...
class SRAA(nn.Module):
    ...
    def __init__(self):
        ...
        self.fenliang2 = BasicConv2d(576, 16, 1)
        self.fenliang3 = BasicConv2d(640, 16, 1)
        self.fenliang4 = BasicConv2d(704, 16, 1)
        ...
        self.xiao2 = nn.Conv2d(512, 64, 1)
        self.xiao3 = nn.Conv2d(64, 64, 1)
        self.xiao4 = nn.Conv2d(64, 64, 1)
