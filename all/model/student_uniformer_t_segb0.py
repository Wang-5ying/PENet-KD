...
# from backbone.mix_transformer import mit_b0
from mmseg.models.backbones.mix_transformer import mit_b0
...
class SRAA(nn.Module):
    ...
    def __init__(self):
        ...
        # 64 128 320 512
        self.resnet = mit_b0()
        self.resnet_depth = mit_b0()
        self.raa1 = RRAA(in_channel=32, out_channel=32, h=80, w=80)
        self.raa2 = RRAA(in_channel=64, out_channel=64, h=40, w=40)
        self.raa3 = RRAA(in_channel=160, out_channel=160, h=20, w=20)
        self.raa4 = RRAA(in_channel=256, out_channel=256, h=10, w=10)
        ...
        self.b1 = BasicConv2d(32, 16, 3, 1, 1)
        ...
        self.edge1 = edge(32, 1)
        self.edge2 = edge(160, 1)

        self.before1 = BasicConv2d(256, 128, 3, 1, 1)
        self.r1 = BasicConv2d(128, 64, 3, 1, 1)
        ...
        self.fenliang1 = BasicConv2d(256, 16, 1)
        self.fenliang2 = BasicConv2d(256 + 160, 16, 1)
        self.fenliang3 = BasicConv2d(256 + 160 + 64, 16, 1)
        self.fenliang4 = BasicConv2d(256 + 160 + 64 + 32, 16, 1)
        ...
        self.er1 = nn.Conv2d(32, 64, 1)
        self.er2 = nn.Conv2d(64, 128, 1)
        self.er3 = nn.Conv2d(160, 256, 1)
        self.er4 = nn.Conv2d(256, 512, 1)

        self.ed1 = nn.Conv2d(32, 64, 1)
        self.ed2 = nn.Conv2d(64, 128, 1)
        self.ed3 = nn.Conv2d(160, 256, 1)
        self.ed4 = nn.Conv2d(256, 512, 1)
    def forward(self, r, d):
        ...
        return res, b2, b3, b4, edge1, edge2, kdr, kdd, decode
