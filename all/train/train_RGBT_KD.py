...
# from xiugai3.student_uniformer_t_segb0 import SRAA as student
import matplotlib.pyplot as plt
from xiugai3.student_uniformer_t import SRAA as student
...
# net2.load_pret("/media/user/shuju/seg_pre/segformer.b0.512x512.ade.160k.pth")
...
# net2.load_state_dict(torch.load('/home/user/Documents/wby/backbone/Shunted/ckpt_T.pth'))
net2.load_pret("/home/user/Documents/wby/backbone/Shunted/ckpt_T.pth")
net1 = net1.cuda()
net2 = net2.cuda()
################################################################################################################
...
for epoch in range(epochs):
    ...
    for i, sample in enumerate(train_dataloader):
        ...
        s4_out, s3_out, s2_out, s1_out, out_r, out_d, rlayer_features, tlayer_features, decode = net2(image, depth)
        ...
        #
        kd5 = kld(decode[0] / temp, decode_t[0] / temp, label, 3)
        kd6 = kld(decode[1] / temp, decode_t[1] / temp, label, 3)
        kd7 = kld(decode[2] / temp, decode_t[2] / temp, label, 3)
        kd8 = kld(decode[3] / temp, decode_t[3] / temp, label, 3)
        ...
        cross = kd9 + kd10 + kd11 + kd12 + kd13 + kd14 + kd15 + kd16
